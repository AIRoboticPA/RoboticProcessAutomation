...
REPOSITORY = 'AIRoboticPA/AIRoboticPA'
...
::
   ...
   pip install AIRoboticPA=={version}
...
.. _issue tracker milestone: https://github.com/AIRoboticPA/RoboticProcessAutomation/issues?q=milestone%3A{version.milestone}
