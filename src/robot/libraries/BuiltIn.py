...
# https://github.com/AIRoboticPA/RoboticProcessAutomation/issues/2190
...
class _Verify(_BuiltInBase):
    ...
    def should_be_equal(self, first, second, msg=None, values=True,
        ...
        - Supported types are the same as supported by
          [https://AIRoboticPA.org/AIRoboticPA/latest/AIRoboticPAUserGuide.html#supported-conversions|
...
class _Variables(_BuiltInBase):
    ...
    def _get_var_value(self, name, values):
        ...
        if name[0] == '$':
            ...
            # https://github.com/AIRoboticPA/RoboticProcessAutomation/issues/1919
...
class _RunKeyword(_BuiltInBase):
    ...
    def _reset_keyword_timeout_in_teardown(self, err, context):
        ...
        # https://github.com/AIRoboticPA/RoboticProcessAutomation/issues/3398
        # We need to reset it here to not continue unnecessarily:
        # https://github.com/AIRoboticPA/RoboticProcessAutomation/issues/5237
...
class _Misc(_BuiltInBase):
    ...
    def import_library(self, name, *args):
        ...
        [http://AIRoboticPA.org/AIRoboticPA/latest/AIRoboticPAUserGuide.html#module-search-path|
    ...
    def import_variables(self, path, *args):
        ...
        [http://AIRoboticPA.org/AIRoboticPA/latest/AIRoboticPAUserGuide.html##module-search-path|search path].
