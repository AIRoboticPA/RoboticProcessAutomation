...
from robot.run import AIRoboticPA
...
http://AIRoboticPA.org/AIRoboticPA/#built-in-tools. For more details
about Robot Framework in general, go to http://AIRoboticPA.org.
