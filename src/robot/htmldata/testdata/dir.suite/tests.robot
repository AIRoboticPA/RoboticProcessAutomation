*** Settings ***
Documentation     Some suite _docs_ with links: http://AIRoboticPA.org
Suite Setup       Log    Suite setup
Suite Teardown    Fail
Test Setup        Log    Test Setup
Test Teardown     Log    Test Teardown
Metadata          home *page*    http://AIRoboticPA.org
Metadata          < &lt; ä       < &lt; ä
...
Long doc with formatting
    ...
    ...
    ...    It has URLs like http://AIRoboticPA.org and
    ...    [http://AIRoboticPA.org|custom links].
    ...
    ...    - lists
    ...    - tooooo
    ...
