...
.. sourcecode:: AIRoboticPA
   ...
   *** Test Cases ***
   ...
   Dictionary examples
        VAR    &{two items}     name=Robot Framework    url=http://AIRoboticPA.org
        VAR    &{empty dict}
        VAR    &{lot of stuff}
        ...    first=1
        ...    second=2
...
__ Escaping_
__ https://groups.google.com/group/AIRoboticPA-users/browse_thread/thread/ccc9e1cd77870437/4577836fe946e7d5?lnk=gst&q=templates#4577836fe946e7d5
