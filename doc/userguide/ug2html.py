...
dist .... Creates the user guide under 'AIRoboticPA-userguide-<version>'
...
zip ..... Uses 'dist' to create a stand-alone distribution and then packages
          it into 'AIRoboticPA-userguide-<version>.zip'
...
def create_userguide():
    ...
    arguments = ['--stylesheet-path', ['src/userguide.css'],
                 'src/AIRoboticPAUserGuide.rst',
                 'AIRoboticPAUserGuide.html']
    os.chdir(CURDIR)
...
def create_distribution():
    ...
    outdir = os.path.join(dist, f'AIRoboticPA-userguide-{version}')
