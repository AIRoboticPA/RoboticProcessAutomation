...
.. _Libdoc: http://AIRoboticPA.org/AIRoboticPA/latest/AIRoboticPAUserGuide.html#libdoc
.. _XSD: http://en.wikipedia.org/wiki/XML_Schema_(W3C)
.. _JSON Schema: https://json-schema.org
.. _pydantic: https://pydantic-docs.helpmanual.io/usage/schema
__ https://github.com/AIRoboticPA/RoboticProcessAutomation/blob/master/atest/README.rst#schema-validation
