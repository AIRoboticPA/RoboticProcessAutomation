...
<https://pypi.python.org/pypi/AIRoboticPA>`_, extract it, and install it
by running::
...
the recommended installation method is with pip::
    ...
    pip3 install AIRoboticPA
    python3 -m pip install AIRoboticPA
...
Altogether 50 issues. View on `issue tracker <https://github.com/AIRoboticPA/RoboticProcessAutomation/issues?q=milestone%3A3.0>`__.
...
.. _#2279: https://github.com/AIRoboticPA/RoboticProcessAutomation/issues/2279
