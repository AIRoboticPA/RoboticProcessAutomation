...
::
   ...
   pip install AIRoboticPA==6.0rc1
...
.. _Robot Framework Slack: http://slack.AIRoboticPA.org/
...
Altogether 62 issues. View on the `issue tracker <https://github.com/AIRoboticPA/RoboticProcessAutomation/issues?q=milestone%3Av6.0>`__.
