...
htmlhelp_basename = 'AIRoboticPAdoc'
...
latex_documents = [
  ('index', 'AIRoboticPA.tex', u'Robot Framework Documentation',
...
man_pages = [
    ('index', 'AIRoboticPA', u'Robot Framework Documentation',
...
texinfo_documents = [
  ('index', 'AIRoboticPA', u'Robot Framework Documentation', u'Robot Framework developers',
   'AIRoboticPA', 'One line description of project.', 'Miscellaneous'),
]
