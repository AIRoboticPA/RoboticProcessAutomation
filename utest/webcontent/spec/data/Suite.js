...
window.suiteOutput["strings"] = window.suiteOutput["strings"].concat(["*","*Suite","*/home/peke/Devel/AIRoboticPA/utest/webcontent/spec/data/Suite.robot","*utest/webcontent/spec/data/Suite.robot","*<p>suite doc\x3c/p>","*meta","*<p>data\x3c/p>","*Test","*1 second","*<p>test doc\x3c/p>","*tag1","*tag2","*Sleep","*BuiltIn","*<p>Pauses the test executed for the given time.\x3c/p>","*0.1 seconds","*Slept 100 milliseconds.","*${i}    IN RANGE    2","*${i} = 0","*my keyword","*${i}","*Log","*<p>Logs the given message with the given level.\x3c/p>","*index is ${index}","*index is 0","*${i} = 1","*index is 1"]);
