...
window.passingFailingOutput["strings"] = window.passingFailingOutput["strings"].concat(["*","*PassingFailing","*/home/peke/Devel/AIRoboticPA/utest/webcontent/spec/data/teardownFailure/PassingFailing.robot","*utest/webcontent/spec/data/teardownFailure/PassingFailing.robot","*Passing","*Log","*BuiltIn","*<p>Logs the given message with the given level.\x3c/p>","*passing","*Failing","*In test","*Fail","*<p>Fails the test with the given message and optionally alters its tags.\x3c/p>"]);
