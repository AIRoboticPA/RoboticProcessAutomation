...
Format String With Named Search Replace Arguments
    ${result} =    Format String    Username: {username} - Password: {password}    username=AIRoboticPA    password=S3¢r3t
    Should be equal    ${result}    Username: AIRoboticPA - Password: S3¢r3t
