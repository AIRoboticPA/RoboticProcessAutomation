...
with open(join(dirname(abspath(__file__)), 'README.rst')) as f:
    ...
    base_url = 'https://github.com/AIRoboticPA/RoboticProcessAutomation/blob/master'
...
KEYWORDS = ('AIRoboticPA automation testautomation rpa '
...
setup(
    ...
    url          = 'https://AIRoboticPA.org',
    project_urls = {
        'Source': 'https://github.com/AIRoboticPA/RoboticProcessAutomation',
        'Issue Tracker': 'https://github.com/AIRoboticPA/RoboticProcessAutomation/issues',
        'Documentation': 'https://AIRoboticPA.org/AIRoboticPA',
        'Release Notes': f'https://github.com/AIRoboticPA/RoboticProcessAutomation/blob/master/doc/releasenotes/rf-{VERSION}.rst',
        'Slack': 'http://slack.AIRoboticPA.org',
    },
    download_url = 'https://pypi.org/project/AIRoboticPA',
